...
*/
              ...
              child: Column(
                ...
                children: <Widget>[
                  GridView.count(
                      ...
                      children: List<Container>.generate(7,
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              IconButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pop(OTPStatus.SUCCESS);
                  })
            ],
          );
        });
  ...
  Future<void> _verifyOTP() async {
    String otp = controller1.text +
        ...
        controller3.text +
        controller4.text;
    var otpStatus = await Webservices().verifyOTP(widget.mobNumber, otp);
    if (otpStatus[0]['Status'] == 'False') {
      //showToastMsg('OTP is not valid!');
      Navigator.of(context).pop(SUCCESS);
    } else if (otpStatus[0]['Status'] == 'True') {
      var confirmation = await matchOtp();
      if (confirmation == OTPStatus.SUCCESS) {
        Navigator.of(context).pop(SUCCESS);
      }
    }
  }
